              ...
              <StaggerItem key={product.id}>
                <GlassCard className="h-full flex flex-col">
                  <div className="p-6 flex-1 flex flex-col">
                    {/* Icon */}
                    <div
                      className={`w-12 h-12 rounded-[10px] ${colors.bg} border ${colors.border} flex items-center justify-center text-[22px] mb-5`}
                    >
                      {product.icon}
                    </div>
                    ...
                    {/* Tagline */}
                    <p className={`text-[13px] font-medium ${colors.text} mb-3`}>
